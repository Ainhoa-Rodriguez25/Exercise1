...
The application implements several mathematical functionalities following the MVC (Model-View-Controller) architectural pattern.  
Each functionality is fully tested (Service and Controller layers) and the application is dockerized.
...
### 5️⃣ Factorial Calculator (Optional Functionality)
...
DockerHub repository: https://hub.docker.com/r/ainhoaro/spring-boot-demoapp
